...
import {default as Eventable} from '../core/Eventable';
 ...
 *
 */
class BaseObject extends Eventable(Base) {
    constructor(id) {
        super();
        this.isAdd = false;
    ...
    getCenter() {
        ...
        if (coordinate) {
            return coordinate instanceof Coordinate ? coordinate : new Coordinate(coordinate);
        }
        else {
