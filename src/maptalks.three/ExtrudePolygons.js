...
class ExtrudePolygons extends MergedMixin(BaseObject) {
    constructor(polygons, options, material, layer) {
        ...
        for (let i = 0; i < len; i++) {
            ...
            else if (center instanceof Coordinate) {
                x = center.x;
                y = center.y;
            }
        ...
        const center = new Coordinate((minX + maxX) / 2, (minY + maxY) / 2);
        options = Util.extend({}, OPTIONS, options, { layer, polygons, coordinate: center });
